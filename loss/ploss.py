import sys
sys.path.append(r"/root/autodl-tmp/Basedale")

import torch.nn as nn
from torchvision.models.vgg import vgg16, vgg19,VGG16_Weights
...
class PerceptualLoss(nn.Module):
    ...
    def __init__(self):
        ...
        vgg = vgg16(weights=VGG16_Weights.IMAGENET1K_V1).cuda()
        self.loss_network = nn.Sequential(*list(vgg.features)[:16]).eval()
        for param in self.loss_network.parameters():
            param.requires_grad = False
